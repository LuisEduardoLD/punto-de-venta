...
from apps.Producto.models import TBL_CATEGORIA_ALIMENTOS
...
class usuariosForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'first_name', 'apellido_paterno', 'apellido_materno', 'email', 'id_typoUsuario', 'col', 'calle',
            'numero_ext', 'numero_cel', 'fecha_nacimiento', 'username', 'password', 'is_active'
        ]
