...
!function (t, e) {
    ...
    var Ot = "dropdown", xt = i.default.fn[Ot], jt = new RegExp("38|40|27"), Lt = {
        ...
        return e.toggle = function () {
            ...
            if (!this._menu) {
                ...
                e && (this._menu = e.querySelector(".dropdown-alimentos_dir"))
            }
            return this._menu
        }, e._getPlacement = function () {
            var t = i.default(this._element.parentNode), e = "bottom-start";
            return t.hasClass("dropup") ? e = i.default(this._menu).hasClass("dropdown-alimentos_dir-right") ? "top-end" : "top-start" : t.hasClass("dropright") ? e = "right-start" : t.hasClass("dropleft") ? e = "left-start" : i.default(this._menu).hasClass("dropdown-alimentos_dir-right") && (e = "bottom-end"), e
            ...
            if (!(/input|textarea/i.test(e.target.tagName) ? 32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || i.default(e.target).closest(".dropdown-alimentos_dir").length) : !jt.test(e.which)) && !this.disabled && !i.default(this).hasClass("disabled")) {
                ...
                if (o || 27 !== e.which) {
                    ...
                    var r = [].slice.call(n.querySelectorAll(".dropdown-alimentos_dir .dropdown-item:not(.disabled):not(:disabled)")).filter((function (t) {
    ...
    var he = i.default.fn.tab, pe = function () {
        ...
        return e.show = function () {
            ...
            if (e) {
                i.default(e).removeClass("active");
                var o = i.default(e.parentNode).find("> .dropdown-alimentos_dir .active")[0];
                o && i.default(o).removeClass("active"), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
            }
            if (i.default(t).addClass("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), l.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && i.default(t.parentNode).hasClass("dropdown-alimentos_dir")) {
